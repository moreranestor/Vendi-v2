...
class Inventario:
    ...
    def view(self, page: Page, params: params, basket: Basket):
        ...
        productos_ = ProductoMov.getInventario()
        productos = [x for x in productos_ if x["existencias"] > 0]
            ...
            try:
                ...
                lista_moviminetos.controls = (
                    [
                        ...
                        for mov in productos_filtrados
                    ]
    ...
    def mostrar_Mov(self, mov):
        # Crear diálogo para mostrar productosE
        dialog = AlertDialog(
    ...
    def mostrar_e(self, page, mov):
        # Navegar a vista de detalle de productosE para este mov
        print()
