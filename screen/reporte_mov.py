...
class Movimientos:
    ...
    def view(self, page: Page, params: params, basket: Basket):
        ...
        ProductoMov = ProductoModel()

        movimietos = ProductoMov.getMov()
        ...
        def filtrar_moviminetos(e):
            ...
            try:
                                        ...
                                        Row(
                                            controls=[
                                                IconButton(
                                                    ...
                                                    on_click=lambda e, c=mov: self.mostrar_e(
                                                        page, c
                                                    ),
                                                    autofocus=False,
                                                ),
                                                IconButton(
                                                    ...
                                                    on_click=lambda e, c=mov: self.mostrar_s(
                                                        page, c
                                                    ),
                                                    autofocus=False,
                                                ),
                                                IconButton(
                                                    ...
                                                    on_click=lambda e, c=mov: self.mostrar_v(
                                                        page, c
                                                    ),
                                                    autofocus=False,
                                                ),
                                    ...
                                    controls=[
                                        ...
                                        Column(
                                            controls=[
                                                ...
                                                Text(
                                                    f"{mov['entradas']-mov['salidas']-mov['ventas']}",
                ...
                if not moviminetos_filtrados:
                    _mostrar_alerta(
                        "error", "No se encontraron moviminetos en este rango", True
                    )
            ...
            content=Row(
                controls=[
                    ...
                    Column(
                        ...
                        controls=[
                            Text(
                                "Revice el historial de movimientos.",
                                size=12,
        ...
        content_area = Container(
            ...
            content=Column(
                ...
                controls=[filtro_container, lista_moviminetos],
                spacing=0,
            ),
        )
